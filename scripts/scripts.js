...
// the bottom text now leaves sooner which is progress I suppose
...
// Resets form if "clear" clicked
  ...
  // I don't know anymore... the submit button worked then just stopped and im struggling to fix it
  // $("#submit").click(() => {
  //   form.classList.remove("validated");
  //   document.querySelector(".topping-list").style.display = "none";
  //   form.reset();
